		...
		<div class="row">
			...
			<article class="col-sm-9 maincontent">
				...
				<div  class ="vertical">
					<nav>
						<ul>
							<a href="adicionarcliente"><li class="btn">Adicionar Cliente<li></a>
							<a href="adicionarservico"><li class="btn">Adicionar Serviço<li></a>
							<a href="adicionarnoticia"><li class="btn active">Adicionar Noticias<li></a>
				...
				<div id="right">
				<form method="POST" action="/index.php/ControleAdmin/inserenot">
						<div class="col-sm-8">
							<input class="form-control" type="text" placeholder="Titulo" name="titulo">
						</div>
						<br><br>
						<div class="col-sm-10">
							<input class="form-control" type="date" placeholder="Data da noticia" name="data">
						</div>
						<br><br>
						<div class="col-sm-10">
							<input class="form-control" type="text" placeholder="URL da imagem" name="url">
						</div>
						<br><br>
						<div class="col-sm-10">
							<textarea class="form-control" rows="3" placeholder="Descriçao" name="descricao"></textarea>
						</div>
						<br><br><br><br>
						<div class="col-sm-10">

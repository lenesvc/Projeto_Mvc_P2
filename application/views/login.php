	...
	<div class="navbar navbar-inverse navbar-fixed-top headroom" >
		<div class="container">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="index.html"><img src="<?php echo base_url(); ?>static/imagens/logoh.png" alt="Logo"></a>
			</div>
			<div class="navbar-collapse collapse">
				<ul class="nav navbar-nav pull-right">
					...
					<li><a href="login">Area Exclusiva</a></li>
		...
		<div class="row">
			...
			<article class="col-sm-9 maincontent">
				<header class="page-header">
					<h1 class="page-title">Area Exclusiva</h1>
				</header>
				...
				<br>
					<form method="POST" action="/index.php/Controle/Auth">
						<div class="row">
							<div class="col-sm-4">

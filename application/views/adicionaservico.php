	...
	<div class="container">
		...
		<div class="row">
			...
			<article class="col-sm-9 maincontent">
				...
				<div  class ="vertical">
					<nav>
						<ul>
							...
							<a href="adicionarservico"><li class="btn active">Adicionar Serviço<li></a>
							<a href="adicionarnoticia"><li class="btn">Adicionar Noticias<li></a>
							<a href="listar"><li class="btn">Listar Mensagens<li></a>
				...
				<div id="right">
				<form method="POST" action="/index.php/ControleAdmin/insereserv">
					<div class="col-sm-10">
